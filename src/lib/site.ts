...
export const CLIENTS = [
  { name: "Mintree", logo: "/clients/mintree.png" },
  { name: "Agami", logo: "/clients/agami.png" },
  { name: "Skiniss", logo: "/clients/skiniss.png" },
  { name: "Sumaya", logo: "/clients/sumaya.png" },
  { name: "Showshaa", logo: "/clients/showshaa.png" },
  { name: "Trulyganic", logo: "/clients/trulyganic.png" },
  { name: "Corcul", logo: "/clients/corcul.png" },
  { name: "IIM Lucknow", logo: "/clients/iim-lucknow.png" },
  { name: "Press.com", logo: "/clients/presscom.png" },
  { name: "Doselo Healthcare", logo: "/clients/doselo-healthcare.png" },
  { name: "Celestique", logo: "/clients/celestique.png" },
  { name: "Redo Herbs", logo: "/clients/redo-herbs.png" },
  { name: "DFB Dhanshri", logo: "/clients/dfb-dhanshri.png" },
  { name: "US", logo: "/clients/us.png" },
  { name: "Ayurmacy", logo: "/clients/ayurmacy.png" },
  { name: "Lilsy Professional", logo: "/clients/lilsy-professional.png" },
  { name: "Gold Gifts", logo: "/clients/gold-gifts.png" },
  { name: "Jaat Pantry House", logo: "/clients/jaat-pantry-house.png" },
  { name: "Aumrit", logo: "/clients/aumrit.png" },
  { name: "Alpspure Nutra", logo: "/clients/alpspure-nutra.png" },
];